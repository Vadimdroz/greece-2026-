...
// Original stylized illustrations for this app (not photographs) — hosted
// locally at public/images/hero/. `source` links to the place's Wikipedia
// page for anyone curious to learn more, not to a photo credit.
const HERO_PHOTOS: HeroPhoto[] = [
  {
    src: "./images/hero/delphi-sanctuary.jpg",
    place: "Delphi · Sanctuary of Apollo",
    credit: "Original illustration for this app",
    source: "https://en.wikipedia.org/wiki/Delphi",
    dayNumber: 2
  },
  {
    src: "./images/hero/lake-plastiras.jpg",
    place: "Lake Plastiras",
    credit: "Original illustration for this app",
    source: "https://en.wikipedia.org/wiki/Lake_Plastiras",
    dayNumber: 3
  },
  {
    src: "./images/hero/meteora.jpg",
    place: "Meteora · monasteries on the rocks",
    credit: "Original illustration for this app",
    source: "https://en.wikipedia.org/wiki/Meteora",
    dayNumber: 6
  },
  {
    src: "./images/hero/thessaloniki-tower.jpg",
    place: "Thessaloniki · White Tower",
    credit: "Original illustration for this app",
    source: "https://en.wikipedia.org/wiki/White_Tower_of_Thessaloniki",
    dayNumber: 7
  },
  {
    src: "./images/hero/thermopylae.jpg",
    place: "Thermopylae",
    credit: "Original illustration for this app",
    source: "https://en.wikipedia.org/wiki/Thermopylae",
    dayNumber: 8
  },
  {
    src: "./images/hero/nafplio-oldtown.jpg",
    place: "Nafplio · old town",
    credit: "Original illustration for this app",
    source: "https://en.wikipedia.org/wiki/Nafplio",
    dayNumber: 9
  }
];
