...
const SPOT_LABEL: Record<"north" | "south", { en: string; he: string }> = {
  north: { en: "Delphi", he: "דלפי" },
  south: { en: "Thessaloniki", he: "תסלוניקי" }
};
...
const SPOTS = [
  { key: "north", label: "Delphi", lat: 38.4824, lon: 22.5010 },
  { key: "south", label: "Thessaloniki", lat: 40.6401, lon: 22.9444 }
] as const;
      ...
      try {
        ...
        await Promise.all(
          SPOTS.map(async spot => {
            const url = `https://api.open-meteo.com/v1/forecast?latitude=${spot.lat}&longitude=${spot.lon}&current=temperature_2m,weather_code&daily=temperature_2m_max,temperature_2m_min,weather_code&timezone=Europe%2FAthens&forecast_days=5`;
