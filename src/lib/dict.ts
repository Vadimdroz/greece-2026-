...
export const DICT = {
  /* ---------- Brand / hero ---------- */
  brand: { en: "Greece 2026", he: "יוון 2026" },
  brand_short: { en: "Greece", he: "יוון" },
  ...
  families_byline: {
    en: "The Drozdovski family · August 2026",
    he: "משפחת דרוזדובסקי · אוגוסט 2026"
  },
  hero_before_lead: {
    en: "Counting down to the road trip through Greece",
    he: "סופרים לאחור לטיול הכביש ביוון"
  },
  hero_today_lead: { en: "Today in Greece", he: "היום ביוון" },
  hero_tomorrow_lead: { en: "Tomorrow in Greece", he: "מחר ביוון" },
  hero_after_lead: { en: "That trip through Greece", he: "אותו טיול ביוון" },
  hero_after_title: { en: "Kalos irthate", he: "ברוכים השבים" },
  hero_after_sub: {
    en: "15 — 23 August 2026 · the family edition",
    he: "15 — 23 באוגוסט 2026 · מהדורת המשפחה"
  },
  hero_close_almost: {
    en: "Kalo taxidi — almost there",
    he: "קאלו טאקסידי — כמעט שם"
  },
  hero_one_week: {
    en: "One week to go · time to pack the booster seats",
    he: "שבוע נותר · הגיע הזמן לארוז את כיסאות הבטיחות"
  },
  hero_one_month: {
    en: "Less than a month · resolve the double-booked hotels",
    he: "פחות מחודש · להכריע בין המלונות הכפולים"
  },
  hero_far: {
    en: "A Greek road trip, on the horizon",
    he: "טיול כביש יווני, באופק"
  },
  hero_today_day: { en: "Day", he: "יום" },
  hero_tomorrow_day: { en: "Tomorrow", he: "מחר" },
  hero_of_ten: { en: "of nine", he: "מתוך תשעה" },
  ...
  region_north_long: { en: "Delphi & Plastiras", he: "דלפי ופלסטירה" },
  region_south_long: { en: "Thessaloniki & Nafplio", he: "תסלוניקי ונאפפליו" },
  ...
  gem_title: { en: "Nikos", he: "ניקוס" },
  gem_tagline: {
    en: "Your Greek friend on the road",
    he: "החבר היווני שלכם בדרכים"
  },
  gem_setup_title: { en: "Set up Nikos", he: "הגדרת ניקוס" },
  gem_setup_blurb: {
    en: "Nikos uses Google's Gemini Live API to talk with you. Paste a free Gemini API key — it's saved on this device only and never shared.",
    he: "ניקוס משתמש ב־Gemini Live API של גוגל כדי לדבר אתכם. הדביקו מפתח Gemini API חינמי — הוא נשמר במכשיר הזה בלבד ולא נשלח לשום מקום אחר."
  },
  gem_setup_link: {
  ...
  gem_first_hint: {
    en: "Try: \"What should we do tomorrow morning?\" or \"Tell me a story about Delphi.\"",
    he: "נסו: \"מה כדאי לעשות מחר בבוקר?\" או \"ספר לי סיפור על דלפי.\""
  },
  ...
  stays_intro: {
    en: "We split the trip across four bases — Delphi, Lake Plastiras, Thessaloniki and Nafplio — each chosen as the right stop for the days around it.",
    he: "אנחנו מחלקים את הטיול בין ארבע תחנות - דלפי, אגם פלסטירה, תסלוניקי ונאפפליו - כל אחת נבחרה כבסיס הנכון לימים שסביבה."
  },
  ...
  /* ---------- Weather ---------- */
  weather_eyebrow: { en: "Right now in Greece", he: "עכשיו ביוון" },
  weather_north: { en: "Delphi & Plastiras", he: "דלפי ופלסטירה" },
  weather_south: { en: "Thessaloniki & Nafplio", he: "תסלוניקי ונאפפליו" },
  ...
  word_eyebrow: { en: "Greek word of the day", he: "המילה היוונית של היום" },
  ...
  word_example_chip_listen: {
    en: "Play example (Greek, then English, then Hebrew)",
    he: "השמעת המשפט (יוונית, אחר כך אנגלית, ואז עברית)"
  },
  ...
  food_title: { en: "What Greece tastes like", he: "הטעם של יוון" },
  food_kicker: {
  ...
  food_filter_north: { en: "Delphi & Plastiras", he: "דלפי ופלסטירה" },
  food_filter_south: { en: "Thessaloniki & Nafplio", he: "תסלוניקי ונאפפליו" },
  food_filter_tuscany: { en: "Across Greece", he: "כל יוון" },
  ...
  drink_kicker: {
    en: "Adults only — Greece pours generously",
    he: "למבוגרים בלבד — יוון מוזגת ברוחב יד"
  },
  ...
  install_step_confirm_hint: {
    en: "The Greece icon lands on your home screen",
    he: "הסמל של יוון מופיע במסך הבית"
  },
