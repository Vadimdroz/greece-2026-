...
const TRIP_FACTS = {
  ...
  bases: ["Delphi", "Lake Plastiras", "Pelion (Agios Ioannis)", "Thessaloniki", "Nafplio"],
  ...
  planNotes: [
    ...
    "Pelion (Agios Ioannis) was added on Day 6, swapped in for what used to be a second Thessaloniki night. Thessaloniki is now just 1 night (21–22 Aug) instead of 2. No hotel is booked in Pelion yet — that's the one real gap in the trip's bookings, unlike everywhere else which is booked (if double-booked). Waterland moved to Day 8 morning, before Thermopylae/Nafplio.",
