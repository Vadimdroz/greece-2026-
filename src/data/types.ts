/** "north" = Delphi + Lake Plastiras leg (the mountain half of the loop),
 *  "south" = Thessaloniki + Nafplio leg (the coastal/return half),
 *  "transit" = drive-through stops (Meteora, Thermopylae) not tied to a base. */
...
export interface Dish {
  ...
  italianName?: string;
  /** "north" = best on the Delphi/Plastiras leg, "south" = best on the
   *  Thessaloniki/Nafplio leg, "greece" = found everywhere we travel. */
  region: "north" | "south" | "greece";
